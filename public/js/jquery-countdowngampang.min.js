...
! function(s) {
    s.fn.CountdownGampang = function(e, o) {
        ...
        function t() {
            ...
            }), l.style.textResponsive && a.find(".ClassyCountdown-value").css("font-size", Math.floor(a.find("> div").eq(0).width() * l.style.textResponsive / 10) + "px"), a.find(".ClassyCountdown-value").each(function() {
        ...
        }(l = s.extend(!0, l, e)).onEndCallback = o, l = e.theme ? ("default" === e.theme && (e.theme = "flat-colors-very-wide"), s.extend(!0, l, n(e.theme))) : s.extend(!0, l, n("flat-colors-very-wide")), a.append('<div class="ClassyCountdown-wrapper"><div class="ClassyCountdown-days"><input type="text" /><span class="ClassyCountdown-value"><div></div><span></span></span></div><div class="ClassyCountdown-hours"><input type="text" /><span class="ClassyCountdown-value"><div></div><span></span></span></div><div class="ClassyCountdown-minutes"><input type="text" /><span class="ClassyCountdown-value"><div></div><span></span></span></div><div class="ClassyCountdown-seconds"><input type="text" /><span class="ClassyCountdown-value"><div></div><span></span></span></div></div>'), a.find(".ClassyCountdown-days input").knob(s.extend({
            width: "100%",
            displayInput: !1,
            readOnly: !0,
            max: 365
        }, l.style.days.gauge)), a.find(".ClassyCountdown-hours input").knob(s.extend({
            width: "100%",
            displayInput: !1,
            readOnly: !0,
            max: 24
        }, l.style.hours.gauge)), a.find(".ClassyCountdown-minutes input").knob(s.extend({
            width: "100%",
            displayInput: !1,
            readOnly: !0,
            max: 60
        }, l.style.minutes.gauge)), a.find(".ClassyCountdown-seconds input").knob(s.extend({
            width: "100%",
            displayInput: !1,
            readOnly: !0,
            max: 60
        }, l.style.seconds.gauge)), a.find(".ClassyCountdown-wrapper > div").attr("style", l.style.element), a.find(".ClassyCountdown-days .ClassyCountdown-value").attr("style", l.style.days.textCSS), a.find(".ClassyCountdown-hours .ClassyCountdown-value").attr("style", l.style.hours.textCSS), a.find(".ClassyCountdown-minutes .ClassyCountdown-value").attr("style", l.style.minutes.textCSS), a.find(".ClassyCountdown-seconds .ClassyCountdown-value").attr("style", l.style.seconds.textCSS), a.find(".ClassyCountdown-value").each(function() {
            s(this).css("margin-top", Math.floor(0 - parseInt(s(this).height()) / 2) + "px")
        }), l.labels && (a.find(".ClassyCountdown-days .ClassyCountdown-value > span").html(l.labelsOptions.lang.days), a.find(".ClassyCountdown-hours .ClassyCountdown-value > span").html(l.labelsOptions.lang.hours), a.find(".ClassyCountdown-minutes .ClassyCountdown-value > span").html(l.labelsOptions.lang.minutes), a.find(".ClassyCountdown-seconds .ClassyCountdown-value > span").html(l.labelsOptions.lang.seconds), a.find(".ClassyCountdown-value > span").attr("style", l.labelsOptions.style));
        ...
        a.find(".ClassyCountdown-wrapper > div").each(function() {
            ...
            s(this).css("margin-top", Math.floor(0 - parseInt(s(this).height()) / 2) + "px")
        })), s(window).trigger("resize"), s(window).resize(s.throttle(50, t))
    }
}(jQuery);